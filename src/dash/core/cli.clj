...
(defn start-repl
  ...
  []
  ; (prints print _G (clojure.string/replace (slurp "resources/branding") #"VERSION" (:dash-version environ/env)) _B) ;; TODO allow for color changes
  (prints print (clojure.string/replace (slurp "resources/branding") #"VERSION" (:dash-version environ/env))) ;; TODO allow branding file changes and don't hardcode the relative path
